    ...
    <section>
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-col" id="footer-col1">
            <h2>Our Awards</h2>
            <p>
          ...
          <div className="footer-col" id="footer-col2">
            <h2>Contact Info</h2>
            <p>
              <ion-icon id="ion-icon" name="phone-portrait-sharp"></ion-icon>
              1-567-124-44227
            </p>
            <p>
              <ion-icon id="ion-icon" name="location-outline"></ion-icon>
              184 Main Street East Perl Habour 8007
            </p>
            <p>
              <ion-icon id="ion-icon" name="alarm-outline"></ion-icon>
            ...
            <div className="footer-flex">
              ...
              <div className="footer-flex-item">
                <img
                  ...
                  alt=""
                  className="footer-flex-item-img"
                />
              </div>
              <div className="footer-flex-item">
                <img
