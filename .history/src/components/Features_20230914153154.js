  ...
  return (
    <div className="feature1">
      ...
      <div className="destination-grid">
        ...
        <div className="destination-grid-item">
            <img src="https://themes-themegoods.b-cdn.net/grandtour/demo/wp-content/uploads/2016/12/pexels-photo-1-700x466.jpg" style={{opacity: "0.1"}} alt="" className="destination-grid-img"/>
            <h3>London</h3>
        </div>
      </div>
    </div>
