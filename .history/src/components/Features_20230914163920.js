    ...
    <div className="feature1">
      ...
      <div className="destination-grid2">
        <div className="destination-grid-item2">
            <img src="https://themes-themegoods.b-cdn.net/grandtour/demo/wp-content/uploads/2016/12/Tokyo_Dollarphotoclub_72848283-copy-700x466.jpg" alt="" className="destination-grid-img2"/>
            <h3>Tokyo</h3>
        </div>
        <div className="destination-grid-item2">
