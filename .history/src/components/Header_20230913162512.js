      ...
      <div className="header">
        ...
        <nav className="header-nav">
          <ul className="header-nav-list">
            ...
            <li className="header-nav-item">Tours</li>
            <li className="header-nav-item">Bookings</li>
            <li className="header-nav-item">Destinations</li>
            <li className="header-nav-item">Pages</li>
            <li className="header-nav-item">Blog</li>
            <li className="header-nav-item">Shortcodes</li>
            <li className="header-nav-item">Shop</li>
            <li></li>
            <li></li>
          </ul>
        </nav>
